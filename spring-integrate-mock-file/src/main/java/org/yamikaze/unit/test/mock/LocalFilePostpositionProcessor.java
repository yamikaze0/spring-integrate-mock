...
public class LocalFilePostpositionProcessor implements PostpositionProcessor {
    ...
    private boolean matchMockCondition(MethodInvokeTime mit) {
    ...
    private void storeMockResult(MethodInvokeTime mit, Object result, Object... args) {
    ...
    private int calculateInvokeTimes(MethodInvokeTime mit) {
        /*
         ...
         */
        return mit.getRealInvokeTimes() + mit.getMockInvokeTimes();
    }
